...
class PessoaResourceIT {
    ...
    public static Pessoa createEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa().nome(DEFAULT_NOME).ativo(DEFAULT_ATIVO);
        return pessoa;
    }
    ...
    public static Pessoa createUpdatedEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa().nome(UPDATED_NOME).ativo(UPDATED_ATIVO);
        return pessoa;
    }
    ...
    void putExistingPessoa() throws Exception {
        ...
        updatedPessoa.nome(UPDATED_NOME).ativo(UPDATED_ATIVO);
    ...
    void partialUpdatePessoaWithPatch() throws Exception {
        ...
        partialUpdatedPessoa.nome(UPDATED_NOME).ativo(UPDATED_ATIVO);
