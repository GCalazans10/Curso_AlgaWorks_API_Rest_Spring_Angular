...
import com.gilberto.repository.CategoriaRepository;
...
/**
 * REST controller for managing {@link com.gilberto.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoriaResource {
    ...
    public ResponseEntity<List<Categoria>> getAllCategorias(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
